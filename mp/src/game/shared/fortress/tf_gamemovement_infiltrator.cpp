...
// Purpose:
//-----------------------------------------------------------------------------
Vector CTFGameMovementInfiltrator::GetPlayerMins( bool bDucked ) const
{
...
// Purpose:
//-----------------------------------------------------------------------------
Vector CTFGameMovementInfiltrator::GetPlayerMaxs( bool bDucked ) const
{
...
// Purpose:
//-----------------------------------------------------------------------------
Vector CTFGameMovementInfiltrator::GetPlayerViewOffset( bool bDucked ) const
{
