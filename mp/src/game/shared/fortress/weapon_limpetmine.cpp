...
// Switched from 0 to 4, otherwise these babies won't deploy ~hogsy
ConVar	weapon_limpetmine_max_deployed( "weapon_limpetmine_max_deployed","4", FCVAR_REPLICATED, "Maximum number of Limpet Mines that can be deployed at a single time" );
