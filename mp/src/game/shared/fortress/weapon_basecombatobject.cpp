...
/*
	DEFINE_PRED_ARRAY( CWeaponBaseCombatObject, m_szObjectName, FIELD_CHARACTER, sizeof( m_szObjectName ) ),
	DEFINE_PRED_FIELD( CWeaponBaseCombatObject, m_vecBuildMins, FIELD_VECTOR, 0 ),
	DEFINE_PRED_FIELD( CWeaponBaseCombatObject, m_vecBuildMaxs, FIELD_VECTOR, 0 ),
*/
