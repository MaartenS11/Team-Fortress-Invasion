...
CLIENTEFFECT_MATERIAL( "sprites/blueflare" )
CLIENTEFFECT_MATERIAL( "sprites/blueflare2" )
...
void CWeaponArcWelder::ViewModelDrawn( C_BaseViewModel *pViewModel )
{
	...
	*/
	...
	sParticle = (SimpleParticle *) pSimple->AddParticle( sizeof( SimpleParticle ), pSimple->GetPMaterial( "sprites/blueflare" ), vecOrigin );
	if ( sParticle == NULL )
		return;
	...
	// Dull Glow
	sParticle = (SimpleParticle *) pSimple->AddParticle( sizeof( SimpleParticle ), pSimple->GetPMaterial( "sprites/blueflare2" ), vecOrigin );
	if ( sParticle == NULL )
		return;
	sParticle->m_flLifetime		= 0.0f;
