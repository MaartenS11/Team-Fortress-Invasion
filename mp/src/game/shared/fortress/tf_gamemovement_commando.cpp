...
Vector CTFGameMovementCommando::GetPlayerMins( bool bDucked ) const
{
	return bDucked ? m_vDuckMins : m_vStandMins; 
}

Vector CTFGameMovementCommando::GetPlayerMaxs( bool bDucked ) const
{
	return bDucked ? m_vDuckMaxs : m_vStandMaxs;
}

Vector CTFGameMovementCommando::GetPlayerViewOffset( bool bDucked ) const
{
