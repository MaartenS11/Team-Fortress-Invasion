...
// Purpose:
//-----------------------------------------------------------------------------
Vector CTFGameMovementMedic::GetPlayerMins( bool bDucked ) const
{
...
// Purpose:
//-----------------------------------------------------------------------------
Vector CTFGameMovementMedic::GetPlayerMaxs( bool bDucked ) const
{
...
// Purpose:
//-----------------------------------------------------------------------------
Vector CTFGameMovementMedic::GetPlayerViewOffset( bool bDucked ) const
{
