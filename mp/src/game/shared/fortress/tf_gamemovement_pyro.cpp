...
// Purpose:
//-----------------------------------------------------------------------------
Vector CTFGameMovementPyro::GetPlayerMins( bool bDucked ) const
{
...
// Purpose:
//-----------------------------------------------------------------------------
Vector CTFGameMovementPyro::GetPlayerMaxs( bool bDucked ) const
{
...
// Purpose:
//-----------------------------------------------------------------------------
Vector CTFGameMovementPyro::GetPlayerViewOffset( bool bDucked ) const
{
