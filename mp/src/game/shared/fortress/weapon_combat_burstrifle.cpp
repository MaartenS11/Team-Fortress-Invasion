...
void CWeaponCombatBurstRifle::PrimaryAttack( void )
{
	...
	do 
	{
		...
		x1 = SharedRandomFloat(__FILE__,-0.5,0.5,++seed);
		x2 = SharedRandomFloat(__FILE__,-0.5,0.5,++seed);
		y1 = SharedRandomFloat(__FILE__,-0.5,0.5,++seed);
		y2 = SharedRandomFloat(__FILE__,-0.5,0.5,++seed);
...
{	
	...
	{
		float flFireRate = ( SequenceDuration() * 0.6f ) + SharedRandomFloat(__FILE__, 0.0, 0.035f, 0 );
	...
	return SharedRandomFloat(__FILE__, 0.075f, 0.15f, 0 );
}
