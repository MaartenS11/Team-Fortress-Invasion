...
// Purpose: Message map
//-----------------------------------------------------------------------------
vgui::MessageMapItem_t CRotationSlider::m_MessageMap[] =
{
	MAP_MESSAGE_INT( CRotationSlider, "SliderMoved", OnSliderMoved, "position" ) 
};
IMPLEMENT_PANELMAP( CRotationSlider, vgui::Slider );
