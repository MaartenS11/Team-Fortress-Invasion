...
BEGIN_PREDICTION_DATA( C_BaseTFPlayer )
	...
	//DEFINE_FIELD( C_BaseTFPlayer, m_iSelectedTarget, FIELD_INTEGER ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_iPersonalTarget, FIELD_INTEGER ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_iLastHealth, FIELD_INTEGER ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_nOldTacticalView, FIELD_INTEGER ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_nOldPlayerClass, FIELD_INTEGER ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_bOldThermalVision, FIELD_BOOLEAN ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_bOldKnockDownState, FIELD_BOOLEAN ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_flStartKnockdown, FIELD_FLOAT ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_flEndKnockdown, FIELD_FLOAT ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_vecOriginalViewAngles, FIELD_VECTOR ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_vecCurrentKnockdownAngles, FIELD_VECTOR ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_vecKnockDownGoalAngles, FIELD_VECTOR ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_bKnockdownOverrideAngles, FIELD_BOOLEAN ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_flKnockdownViewheightAdjust, FIELD_FLOAT ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_flLastMoveTime, FIELD_FLOAT ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_vecLastOrigin, FIELD_VECTOR ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_flLastDamageTime, FIELD_FLOAT ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_flLastGainHealthTime, FIELD_FLOAT ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_flDampeningAmount, FIELD_FLOAT ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_flGoalDampeningAmount, FIELD_FLOAT ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_flDampeningStayoutTime, FIELD_FLOAT ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_flMovementCamoSuppression, FIELD_FLOAT ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_flGoalMovementCamoSuppressionAmount, FIELD_FLOAT ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_flMovementCamoSuppressionStayoutTime, FIELD_FLOAT ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_flNextAdrenalinEffect, FIELD_FLOAT ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_bFadingIn, FIELD_BOOLEAN ),
	//DEFINE_FIELD( C_BaseTFPlayer, m_iIDEntIndex, FIELD_INTEGER ),
	//DEFINE_ARRAY( C_BaseTFPlayer, m_BoostModelAngles, FIELD_FLOAT, 3 ),

	// DEFINE_PRED_TYPEDESCRIPTION( C_BaseTFPlayer, m_RideVehicle, CRideVehicle ),
	// DEFINE_FIELD( C_BaseTFPlayer, m_aTargetReticles, CUtlVector < CTargetReticle * > ),
	// DEFINE_FIELD( C_BaseTFPlayer, m_aSpyCameras, CUtlVector < C_SpyCamera * > ),
	// DEFINE_FIELD( C_BaseTFPlayer, m_ParticleEffect, CParticleEffectBinding ),
	// DEFINE_FIELD( C_BaseTFPlayer, m_ParticleTimer, TimedEvent ),
	// DEFINE_FIELD( C_BaseTFPlayer, m_MaterialHandle, PMaterialHandle ),
	// DEFINE_FIELD( C_BaseTFPlayer, m_pParticleMgr, CParticleMgr ),
	// DEFINE_FIELD( C_BaseTFPlayer, m_pThermalMaterial, IMaterial ),
	// DEFINE_FIELD( C_BaseTFPlayer, m_pCamoEffectMaterial, IMaterial ),
	// DEFINE_FIELD( C_BaseTFPlayer, m_BoostMaterial, CMaterialReference ),
	// DEFINE_FIELD( C_BaseTFPlayer, m_EMPMaterial, CMaterialReference ),
	// DEFINE_FIELD( C_BaseTFPlayer, m_PersonalShieldEffects, CUtlLinkedList < CPersonalShieldEffect* , int > ),
...
bool C_BaseTFPlayer::ShouldDrawViewModel()
{
	...
	if ( gHUD.IsHidden( HIDEHUD_WEAPONSELECTION ) )
		return false;
...
//-----------------------------------------------------------------------------
// Purpose: SPecial hack so tfc1.5 player models will work in tf2 for now
//-----------------------------------------------------------------------------
void C_BaseTFPlayer::StandardBlendingRules( CStudioHdr *pStudioHdr, Vector pos[], Quaternion q[], float currentTime, int boneMask )
{
...
IMaterial *C_BaseTFPlayer::GetCamoMaterial( void )
{
	if ( !m_pCamoEffectMaterial )
	{
		m_pCamoEffectMaterial = materials->FindMaterial("player/infiltratorcamo/infiltratorcamo", NULL);
		if ( m_pCamoEffectMaterial )
...
void FX_ReconParticle( const Vector &vecOrigin, bool bBlue )
{
	...
	for ( int i = 0; i < 1; i++ )
	{
		pParticle = (SimpleParticle *) pSimple->AddParticle( sizeof(SimpleParticle), pSimple->GetPMaterial("particle/particle_smokegrenade"), vecOrigin );
...
//-----------------------------------------------------------------------------
bool C_BaseTFPlayer::CreateMove( float flInputSampleTime, CUserCmd *pCmd )
{
