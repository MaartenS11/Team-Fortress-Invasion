...
{
	return ( ( vecPoint.x > CollisionProp()->OBBMins().x && vecPoint.x < CollisionProp()->OBBMaxs().x ) &&
  	   ( vecPoint.y > CollisionProp()->OBBMins().y && vecPoint.y < CollisionProp()->OBBMaxs().y ) &&
	   ( vecPoint.z > CollisionProp()->OBBMins().z && vecPoint.z < CollisionProp()->OBBMaxs().z ) );
}
