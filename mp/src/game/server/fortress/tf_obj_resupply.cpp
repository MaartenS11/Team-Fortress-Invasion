...
{
	BaseClass::Precache();
	engine->PrecacheModel( RESUPPLY_WALL_MODEL );
	engine->PrecacheModel( RESUPPLY_WALL_MODEL_ALIEN );
	engine->PrecacheModel( RESUPPLY_GROUND_MODEL );
	engine->PrecacheModel( RESUPPLY_GROUND_MODEL_HUMAN );
