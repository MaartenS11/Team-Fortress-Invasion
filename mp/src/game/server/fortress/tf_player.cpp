...
BEGIN_PREDICTION_DATA_NO_BASE( CTFPlayerLocalData )
	...
	DEFINE_FIELD( m_bKnockedDown, FIELD_BOOLEAN ),
	DEFINE_FIELD( m_vecKnockDownDir, FIELD_VECTOR ),
	DEFINE_FIELD( m_bThermalVision, FIELD_BOOLEAN ),
	DEFINE_FIELD( m_iIDEntIndex, FIELD_INTEGER ),
	DEFINE_FIELD( m_iBankResources, FIELD_INTEGER ),
	DEFINE_ARRAY( m_iResourceAmmo, FIELD_INTEGER, RESOURCE_TYPES ),
	//DEFINE_ARRAY( m_aObjects, FIELD_EHANDLE, MAX_OBJECTS_PER_PLAYER ),
	DEFINE_FIELD( m_bAttachingSapper, FIELD_BOOLEAN ),
	DEFINE_FIELD( m_flSapperAttachmentFrac, FIELD_FLOAT ),
...
BEGIN_PREDICTION_DATA( CBaseTFPlayer )
	...
	DEFINE_PRED_TYPEDESCRIPTION( CBaseTFPlayer, m_TFLocal, CTFPlayerLocalData ),
	// DEFINE_FIELD( m_hWeaponBuilder, CHandle < CWeaponBuilder > ),
	DEFINE_FIELD( m_flKnockdownEndTime, FIELD_FLOAT ),
	DEFINE_FIELD( m_vecDeployedAngles, FIELD_VECTOR ),
	DEFINE_FIELD( m_nMedicDamageBoosts, FIELD_INTEGER ),
	DEFINE_FIELD( m_TFPlayerFlags, FIELD_INTEGER ),
	DEFINE_FIELD( m_bCantMove, FIELD_BOOLEAN ),
	DEFINE_FIELD( m_bGagged, FIELD_BOOLEAN ),
	DEFINE_FIELD( m_flLastAttackTime, FIELD_FLOAT ),
	DEFINE_FIELD( m_flCamouflageAmount, FIELD_FLOAT ),
	DEFINE_FIELD( m_flGoalCamouflageAmount, FIELD_FLOAT ),
	DEFINE_FIELD( m_flGoalCamouflageChangeRate, FIELD_FLOAT ),
	DEFINE_FIELD( m_bSwitchingView, FIELD_BOOLEAN ),
	DEFINE_FIELD( m_iPlayerClass, FIELD_INTEGER ),
	// DEFINE_FIELD( m_pCurrentZone, CControlZone ),
	DEFINE_FIELD( m_iCurrentZoneState, FIELD_INTEGER ),
	DEFINE_FIELD( m_bSnapAccuracy, FIELD_BOOLEAN ),
	DEFINE_FIELD( m_flAccuracy, FIELD_FLOAT ),
	DEFINE_FIELD( m_flTargetAccuracy, FIELD_FLOAT ),
	DEFINE_FIELD( m_flLastRicochetNearby, FIELD_FLOAT ),
	DEFINE_FIELD( m_flNumberOfRicochets, FIELD_FLOAT ),
	DEFINE_FIELD( m_flLastExplosionNearby, FIELD_FLOAT ),
	DEFINE_FIELD( m_vecPosDelta, FIELD_VECTOR ),
	DEFINE_ARRAY( m_aMomentum, FIELD_FLOAT, CBaseTFPlayer::MOMENTUM_MAXSIZE ),
	DEFINE_FIELD( m_iMomentumHead, FIELD_INTEGER ),
	DEFINE_FIELD( m_bBuffHealthBoost, FIELD_BOOLEAN ),
	DEFINE_FIELD( m_iHealthBoostTarget, FIELD_INTEGER ),
	DEFINE_FIELD( m_flHealthBoostDecrement, FIELD_FLOAT ),
	DEFINE_FIELD( m_flHealthBoostTime, FIELD_FLOAT ),
	// DEFINE_FIELD( m_hNextPlayerToUpdateOnRadar, EHANDLE ),
	// DEFINE_FIELD( m_hSelectedOrder, CHandle < COrder > ),
	// DEFINE_FIELD( m_pVehicle, IVehicle ),
	DEFINE_FIELD( m_nPreferredTechnology, FIELD_INTEGER ),
	// DEFINE_FIELD( m_flLastTimeDamagedByEnemy, double ),
	// DEFINE_FIELD( m_pCurrentMenu, CMenu ),
	DEFINE_FIELD( m_MenuStringBuffer, FIELD_STRING ),
	...
	DEFINE_FIELD( m_flTimeOfDeath, FIELD_FLOAT ),
	DEFINE_FIELD( m_bDeployed, FIELD_BOOLEAN ),
	DEFINE_FIELD( m_bDeploying, FIELD_BOOLEAN ),
	DEFINE_FIELD( m_bUnDeploying, FIELD_BOOLEAN ),
	DEFINE_FIELD( m_flFinishedDeploying, FIELD_FLOAT ),
...
/*		//SpawnBlood( ptr->endpos - (vecDir * 5), BloodColor(), subInfo.GetDamage() );
		...
		float f1, f2;
		if ( LineSphereIntersection( vec3_origin, 1, vStart, vLineDir, &f1, &f2 ) )
		{
...
void CBaseTFPlayer::DonateResources( CBaseTFPlayer *pTarget, int pCount )
{
	...
	{
		char buf[1024];
		Q_snprintf( buf, 1024, "%s has donated %d resources to you\n",
			STRING( pl.netname ), nTotalCountDonated );
